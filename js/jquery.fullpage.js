    ...
    $.fn.fullpage = function(options) {
        ...
        */
        function setOptionsFromDOM(){
			...
			if(!options.navigationTitles.length){
                options.navigationTitles = sections.filter('[data-titles]').map(function(){
                    return $(this).data('titles').toString();
                }).get();
            }
        ...
        */
        function addVerticalNavigation(){
            ...
            for (var i = 0; i < $(SECTION_SEL).length; i++) {
				...
				var titles = '';
                if (options.navigationTitles.length) {
                    titles = options.navigationTitles[i];
                }

                var li = '<li><a href="#' + link + '"><span></span><label>'+titles+'</label></a>';
